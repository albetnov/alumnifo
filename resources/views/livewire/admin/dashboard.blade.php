            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Jumlah Permintaan (Tambah)</p>
                                <h5 class="font-weight-bolder mb-0">
                                    {{ $requestCount }}
                                </h5>
                            </div>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Jumlah Permintaan (Edit)</p>
                                <h5 class="font-weight-bolder mb-0">
                                    {{ $requestEditCount }}
                                </h5>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="d-flex flex-column h-100">
                                <p class="mb-1 pt-2 text-bold">Alumnifo</p>
                                <h5 class="font-weight-bolder">Alumni Management System</h5>
