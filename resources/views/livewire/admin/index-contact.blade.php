        ...
        <div class="card-header">
            ...
            <div>
                {{-- <button class="btn btn-sm btn-primary"
                    onclick="location.href='{{ route('admin.contact.add') }}'">Create</button> --}}
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="alert alert-danger shadow text-light">SEMUA DATA TABEL KONTAK PUBLIK
                                        AKAN
                                        DIHAPUS. DATA
                                        TIDAK AKAN BISA DIPULIHKAN KEMBALI BILA KAMU MENGHAPUSNYA.
                                    </div>
                                    <p>Konfirmasi Sudo:</p>
